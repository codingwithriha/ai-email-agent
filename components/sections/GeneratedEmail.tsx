...
export default function GeneratedEmail({ email }: { email: string }) {
      ...
      <div className="bg-white/5 border border-white/10 backdrop-blur-xl rounded-2xl p-6 shadow-xl">
        ...
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="flex gap-2">
            ...
            <button className="flex items-center gap-1 text-sm px-3 py-1.5 rounded-lg bg-white/10 hover:bg-white/20 transition">
              <RefreshCcw size={14} />
              Regenerate
            </button>
